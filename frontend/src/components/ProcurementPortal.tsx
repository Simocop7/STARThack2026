  ...
  async function fetchRanking(enriched: EnrichedRequest) {
    ...
    try {
      ...
      const order = {
        ...
        budget_amount: enriched.budget_amount ?? null,
        currency: enriched.currency || currency,
  ...
  async function handleConfirmOrder() {
    ...
    try {
      ...
      const body = {
        ...
        currency: ranking.currency || formData.currency || currencyForCountry(deliveryCountry),
        delivery_country: deliveryCountry,
